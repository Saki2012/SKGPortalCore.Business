...
namespace SKGPortalCore.Repository.SKGPortalCore.Business.Func
{
    ...
    public static class BizAccountLogin
    {
        ...
        /// <returns></returns>
        public static Dictionary<string, string> GetRolePermissionsToken(string secret, List<IRoleModel> userRoles)
        {
        ...
        {
            return CheckAuthenticate(((ISessionWrapper)context.UserContext)?.SessionId, context.GetArgument<string>("jwt"), claimType, claimValue);
        }
        /// <summary>
        /// 驗證功能權限是否有效
        /// </summary>
